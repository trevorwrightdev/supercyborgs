    ...
    <div className={styles.mmoContainer}>
      <div className={styles.mmo}>
        ...
        <div className={styles.mmoSectors}>
          ...
          <p className={styles.sectorDescription}>A rooftop metropolis located at the center of Neon City.</p>
          <h3 className={styles.sectorName}>UTOPIA</h3>
          <p className={styles.sectorDescription}>A wildlife preserve where structures are built to optimally coexist with nature.</p>
          <h3 className={styles.sectorName}>TOKYO</h3>
          <p className={styles.sectorDescription}>A recreation of present day Tokyo, for the future.</p>
          <h3 className={styles.sectorName}>NEO ROME</h3>
          <p className={styles.sectorDescription}>A city of beauty, where the ancient buildings of Rome are combined with contrasting futuristic technology.</p>
          <h3 className={styles.sectorName}>CHASM</h3>
          <p className={styles.sectorDescription}>A crime filled underground sector. </p>
        </div>
